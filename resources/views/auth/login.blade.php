               ...
               <div class="loginBox">
                  ...
                  <form action="{{ Route('login.post') }}" method="post" autocomplete="off">
                     ...
                     <div class="form-group">
                        ...
                        <input type="email" class="form-control" name="email" placeholder="demo@gmail.com" value="{{ old('email') }}" required="required" />
                     ...
                     <div class="form-group">
                        <div class="login-checkbox-area">
                           ...
                           <a href="{{ Route('forgot') }}" class="switcher-text">Forgot Password</a>
                        </div>
                     </div>
                     <div class="form-group">
                        <!-- <button type="submit" class="login-btn-fill">Log in</button> -->
                        <button type="submit" class="login-btn-fill text-center">
                          Log in
                        </button>
                     </div>
                  </form>
